  ...
  return (
    <article className="prose">
      ...
      <p>
        ...
        <span className="font-bold">Daisy UI</span> and react js. With the help
        of Dasisy UI, it comes with{' '}
      ...
      <p>
        ...
        (ofcourse you need backend API for generating and verifying token). This
        template can be used to start your next SaaS project or build new
      ...
      <p>
        ...
        also included Daisy UI Component, that is based on tailwind CSS.
      </p>
      ...
      <p>
        ...
        , a popular free and opensource tailwind component library has been used
        for this template. It has a rich collection of components, layouts and
        is fully customizable and themeable.
      </p>
      ...
      <ul className="mt-0">
        ...
        <li>
          pages - this contain one single file related to one page, if you want
          to divide page into different components file, use features folder and
          create seperate folder related to that page
        </li>
