 ...
 *
 * @export
 * @interface RepairReturnOrderIPagging
 */
export interface RepairReturnOrderIPagging {
  /**
   *
   * @type {Array<RepairReturnOrder>}
   * @memberof RepairReturnOrderIPagging
   */
  data?: Array<RepairReturnOrder>;
  /**
   *
   * @type {number}
   * @memberof RepairReturnOrderIPagging
