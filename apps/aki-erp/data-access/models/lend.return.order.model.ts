 ...
 * 
 * @export
 * @interface LendReturnOrderIPagging
 */
export interface LendReturnOrderIPagging {
  /**
   * 
   * @type {Array<LendReturnOrder>}
   * @memberof LendReturnOrderIPagging
   */
  data?: Array<LendReturnOrder>;
  /**
   * 
   * @type {number}
   * @memberof LendReturnOrderIPagging
