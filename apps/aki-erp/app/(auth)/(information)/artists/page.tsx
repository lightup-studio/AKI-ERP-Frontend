...
const Artists = () => {
  ...
  const dataQuery = usefetchPartnerList({ type: 'Artist', keyword, pageIndex, pageSize });
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        {hasPermission([Action.CREATE_ARTIST]) && (
        ...
        <div className="card bg-base-100 min-h-full w-full p-6 shadow-xl">
          ...
          <div className="flex items-center gap-2">
            ...
            {hasPermission([Action.DELETE_ARTIST]) && (
              <button
