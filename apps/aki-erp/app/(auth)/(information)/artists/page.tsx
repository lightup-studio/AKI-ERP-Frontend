...
const Artists = () => {
  ...
  const [rowSelection, setRowSelection] = React.useState<Record<string, ArtistPartner>>({});
    ...
    <>
      <div className="flex flex-col gap-4">
        <div className="card bg-base-100 min-h-full w-full p-6 shadow-xl">
          <h2 className="border-accent mb-6 border-l-8 pl-4 text-xl font-bold">新增藝術家</h2>
        ...
        <div className="card bg-base-100 min-h-full w-full p-6 shadow-xl">
          <h2 className="border-accent mb-6 border-l-8 pl-4 text-xl font-bold">藝術家列表</h2>
